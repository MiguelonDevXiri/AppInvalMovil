...
const generateFileName = (report: ActecoReportData): string => {
  try {
    ...
    // Formatear hora (HH:MM → HH-MM)
    const cleanTime = report.avisoTime
      .replace(/:/g, '-')
      .replace(/\s+/g, '');
    
    // Construir nombre: Cliente_URGENCIAS_Ubicacion_Fecha_Hora.pdf
    const fileName = `${cleanClient}_URGENCIAS_${cleanLocation}_${cleanDate}_${cleanTime}.pdf`;
          ...
          <div class="info-column">
            ...
            <table class="info-table">
              ...
              <tr>
                ...
                <td class="value">${report.avisoTime || '-'}</td>
              </tr>
              <tr>

...
export default function AveriaMachineFormScreen() {
  ...
  const handleContinue = () => {
    ...
    router.push({
      ...
      params: {
        ...params,
        clientName, avisoDate, avisoTime, location, requestedBy,
        machineType, brand, model, serialNumber, licensePlate,
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          >
            ...
            <Text style={styles.headerTitle}>
              {isEditing ? 'Editar Inspección Averías' : 'Nueva Inspección Averías'}
            </Text>
          ...
          <Card style={styles.clientCard}>
            <Card.Content>
              ...
              <TextInput label="Nombre del cliente *" value={clientName} onChangeText={setClientName} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Nombre completo del cliente" />
              <View style={styles.row}>
                <TextInput label="Fecha *" value={avisoDate} onChangeText={setAvisoDate} style={[styles.input, styles.halfInput]} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="DD/MM/AAAA" />
                <TextInput label="Hora *" value={avisoTime} onChangeText={setAvisoTime} style={[styles.input, styles.halfInput]} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="HH:MM" />
              </View>
              <TextInput label="Ubicación *" value={location} onChangeText={setLocation} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Dirección o ubicación" />
              <TextInput label="Pedido por" value={requestedBy} onChangeText={setRequestedBy} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Persona que solicita" />
            </Card.Content>
          </Card>
          ...
          <Card style={styles.machineCard}>
            <Card.Content>
              ...
              <Divider style={styles.divider} />
              <TextInput label="Tipo de máquina *" value={machineType} onChangeText={setMachineType} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Ej: Compactadora, Prensa, etc." />
              <TextInput label="Marca" value={brand} onChangeText={setBrand} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Marca del fabricante" />
              <TextInput label="Modelo" value={model} onChangeText={setModel} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Modelo de la máquina" />
              <TextInput label="Número de serie" value={serialNumber} onChangeText={setSerialNumber} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="S/N o número de serie" />
              <TextInput label="Matrícula" value={licensePlate} onChangeText={setLicensePlate} style={styles.input} mode="outlined" outlineColor={BRAND_COLORS.grayMedium} activeOutlineColor="#7c3aed" placeholder="Matrícula (si aplica)" />
            </Card.Content>
          </Card>
...
const styles = StyleSheet.create({
  ...
  clientCard: { margin: SPACING.md, borderRadius: BORDER_RADIUS.lg, ...SHADOWS.small },
  machineCard: { marginHorizontal: SPACING.md, marginBottom: SPACING.md, borderRadius: BORDER_RADIUS.lg, ...SHADOWS.small },
